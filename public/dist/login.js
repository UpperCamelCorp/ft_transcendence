        ...
        <div class="flex flex-col w-96 max-w-md bg-[#1E293B] rounded-3xl shadow-2xl backdrop-blur-lg border border-[#334155] text-white p-8">
            ...
            <div class="text-center mt-6">
                <p class="text-[#94A3B8] text-sm">
                    ...
                    <a href="/signup" class="text-[#3B82F6] hover:text-[#2563EB] font-medium transition-colors">Sign up</a>
                </p>
            </div>
        </div>`);
    const loginForm = document.getElementById('loginForm');
    loginForm?.addEventListener('submit', (e) => handleFormSubmit(e, 'api/login', () => router.navigate('/')));
};
